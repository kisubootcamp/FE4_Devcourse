...
// 4. 숫자 크기 비교
/*
    - 변수 a와 b에 임의의 숫자를 할당하세요.
    - a와 b의 크기를 비교하고, a가 크면 "a is greater", b가 크면 "b is greater", 두 값이 같으면 "a and b are equal"을 출력하세요.
*/
{
  const a = 4;
  const b = 16;
...
// 5. 월별 계절 판별
/*
    a. 변수 month에 1에서 12 사이의 숫자를 할당하세요.
    b. month에 따라 해당하는 계절을 출력하세요:
        - 12, 1, 2: "Winter"
        - 3, 4, 5: "Spring"
        - 6, 7, 8: "Summer"
        - 9, 10, 11: "Fall"
