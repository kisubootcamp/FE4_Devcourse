...

{
  ...
  else if (!isAdmin) console.log("Access denied");
...

{
  ...
  else if (a > b) console.log("a is greater");
...

{
  ...
  if (buy > 100000) pay = buy * 0.8;
  else if (buy > 50000) pay = buy * 0.9;
...

{
  ...
  if (num2 === 0) console.log("0임");
  else if (num2 > 0) console.log("양수임");
  else console.log("음수임");
}
