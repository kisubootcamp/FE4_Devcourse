// 03 연산자
{
  ...
  console.log(add, minus, multiply, divide, remainder);
  ...
  // 1.나이비교
  // 두 변수 age1과 age2에 각각 25와 30을 할당하세요.
  // age1이 age2보다 큰지 비교하여 결과를 콘솔에 출력하세요.
  // age1과 age2가 같은지 비교하여 결과를 콘솔에 출력하세요.
  // 삼항 연산자를 사용하여 age1이 age2보다 큰 경우 "Older", 같거나 작은 경우 "Younger or Same"을 출력하세요.
  ...
  console.log(isLoggedIn ? "Welconm" : "Please log in");
  ...
  // 3-6 논리 연산자
  // 1.논리 연산자 기본
  // 변수 a와 b에 각각 true와 false를 할당하세요.
  // a와 b의 논리 AND 연산 결과를 출력하세요.
  // a와 b의 논리 OR 연산 결과를 출력하세요.
  // a의 논리 NOT 연산 결과를 출력하세요.
  {
    const a = true;
    const b = false;
  ...
  // 2.여러 조건 결합
  // 변수 x, y, z에 각각 임의의 숫자를 할당하세요.
  // x가 10보다 크고 y가 5보다 작은지 확인하는 조건을 작성하고, 결과를 출력하세요.
  // x가 10보다 크거나 z가 3보다 큰지 확인하는 조건을 작성하고, 결과를 출력하세요.
  // y가 0이 아닌지 확인하는 조건을 작성하고, 결과를 출력하세요.
  {
    const x = 12;
    const y = 3;
    const z = 13;
  ...
  // 3. 사용자 로그인 및 권한 확인
  // 변수 isLoggedIn과 isAdmin에 각각 true 또는 false를 할당하세요.
  ...
  // 4. 값의 존재 확인
  // 변수 value1과 value2에 각각 임의의 값을 할당하세요. (예: 숫자, 문자열, null, undefined)
  ...
  // 두 변수 모두 값이 존재하지 않는지 확인하는 조건을 작성하고, 결과를 출력하세요.
  {
    ...
    console.log(
      value1 || value2 ? "하나 이상이 값이 존재" : "둘다 존재하지 않음"
    );
    console.log(value1 && value2 ? "모두 존재" : "적어도 하나 존재하지 않음");
  }
  ...
  {
    const num = 56;
    console.log(num >= 0 && num <= 100 ? "0~100사이" : "범위 밖");
    console.log(num < 0 || num > 100 ? "0보다 작거나 100보다 큼" : "범위 밖");
  }
}
