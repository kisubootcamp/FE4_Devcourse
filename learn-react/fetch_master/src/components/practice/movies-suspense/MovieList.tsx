...
export default function MovieList({ fetchPromise, title }: { fetchPromise: Promise<MovieType[]>; title: string }) {
	const movies = use(fetchPromise); // fetchPromise 작업이 끝날 때까지 기다려주고 그 결과를 movies에 담아준다.
	return (
		<>
