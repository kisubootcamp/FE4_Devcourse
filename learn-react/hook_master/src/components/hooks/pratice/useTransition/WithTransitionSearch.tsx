...
export default function WithTransitionSearch() {
		...
		<div className="min-h-screen bg-gray-100  flex items-center justify-center p-4">
			<div className="w-[450px] bg-white rounded-xl shadow-lg p-6 space-y-4">
				<div className="flex items-center justify-between">
					<h2 className="text-xl font-semibold text-gray-800">Without useTransition</h2>
					<div className="flex items-center gap-2">
						{isPending && <Clock className="w-5 h-5 text-blue-500 animate-spin" />}
				...
				<div className="h-[400px] overflow-auto rounded-lg border border-gray-700">
					{filteredItems.map((item) => (
						<div key={item.id} className="p-3 border-b border-gray-700 hover:bg-gray-50">
