            ...
            {isLogin && (
              <div className='flex items-center ml-3'>
                ...
                <div className='relative'>
                  <button onClick={() => navigate('/profile')} className='flex items-center text-sm focus:outline-none'>
                    <Avatar
      ...
      {isMenuOpen && (
        <div className='md:hidden bg-[#0D1117] pb-3 px-4'>
          <div className='pt-2 pb-3 space-y-1'>
            <a href='/' className='block hover:bg-[#21262D] text-[#c9d1d9] px-3 py-2 rounded-md text-base font-medium'>
              Home
            </a>
            <a
              href='/explore'
