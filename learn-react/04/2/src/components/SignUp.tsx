    ...
    <>
      <div className="w-[400px] bg-white px-8 py-10 rounded-xl">
        <div className="mb-8 text-left">
          <h1 className="text-2xl font-bold mb-2">Sign Into App</h1>
        ...
        <div className="flex flex-col gap-5">
          ...
          <div className="flex flex-col gap-3 mt-2">
            <button className="bg-gray-500 text-white py-2 rounded-[8px]">Sign In</button>
            <button className="text-sm text-gray-500 border py-2 rounded-[8px]">Go to Log In</button>
          </div>
        </div>
      </div>
    </>
