      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="flex flex-col items-center gap-4  max-w-[500px]">
          ...
          <ul className="flex items-center antialiased justify-around w-full">
            <li className={twMerge(location === "Seoul" && "font-bold")} onClick={() => handleLocation("Seoul")}>
              <a href="#">Seoul</a>
            </li>
            <li className={twMerge(location === "London" && "font-bold")} onClick={() => handleLocation("London")}>
              <a href="#">London</a>
            </li>
            <li className={twMerge(location === "Paris" && "font-bold")} onClick={() => handleLocation("Paris")}>
              <a href="#">Paris</a>
            </li>
            <li className={twMerge(location === "NewYork" && "font-bold")} onClick={() => handleLocation("NewYork")}>
              <a href="#">NewYork</a>
            </li>
          </ul>
          <div>
