      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 relative z-10">
        <div className="flex flex-col md:flex-row gap-6 md:gap-10 items-center md:items-start">
          ...
          <div className="text-center md:text-left">
            <h1 className="text-3xl font-bold text-white mb-2">보망</h1>
            <p className="text-[#c9d1d9] max-w-2xl mb-4">
              This is Bomang. Tristique volutpat pulvinar vel massa, pellentesque egestas. Eu
              viverra massa quam dignissim aenean malesuada suscipit. Nunc, volutpat pulvinar vel
              mass.
            </p>
            ...
            <div className="flex flex-wrap justify-center md:justify-start gap-6">
              ...
              <div className="flex items-center text-[#8b949e]">
                <span className="text-sm">보망코딩</span>
              </div>
