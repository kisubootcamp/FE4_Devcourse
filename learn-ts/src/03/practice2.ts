...

{
	...
	const mergeObjects = (value1: Person, value2: Workers): Person & Workers => {
...

{
	...
	const getFirstElement = (value: number[] | string[]): number | string | undefined => {
...

{
	...
	const isEqual = (value1: string | number, value2: string | number): boolean => {
...

{
	...
	type UpdatePerson = Person & { address: string };

	// const updateAddress = (value1: Person, value2?: string | undefined): Person | UpdatePerson => {
	// 	if (typeof value2 === "string") {
	//     return { ...value1, address: value2 };
	//   };
	// 	else {
	//     return value1;
	//   };
...

{
	...
	const maxValue = (value1: NumberOrString, value2: NumberOrString): NumberOrString => {
		if (typeof value1 === "number" && typeof value2 === "number") return value1 > value2 ? value1 : value2;
...

{
	...
	type Updated = Person & Contact;

	const createContact = (person: Person, contact: Contact): Updated => {
		return {
			name: person.name,
			age: person.age,
			email: contact.email,
