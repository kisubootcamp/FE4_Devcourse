...
1.2.1.2.1 npm 을 사용해서 vite@latest 패키지의 최신버전을 설치하고,
vite@latest 패키지의 최신버전으로 프로젝트를 생성한다.
1.2.1.3 Vanilla, React, Vue, React , Lit, Svelte 중 선택
1.2.1.4 React -> React + TypeScript, React + TypeScript + SWC, JS,JS+SWC 중 선택
...
1.4 Vite
1.4.1 ESBuild
1.4.1.1 개발모드에서 mnode_modules 폴더에있는 패키지들의 종속성을 사전 번들링하기 위해서 사용합니다.

1.4.2 RollUp
1.4.2.1 배포시에 라이브러리나 모듈들을 번들링하기 위해서 사용한다.

1.4.3 SWC - (Speed Web Compiler)
1.4.3.1 타입스크립트나 JSX 를 자바스크립트로 빠르게 트랜스컴파일 하기 위해서 사용합니다.
