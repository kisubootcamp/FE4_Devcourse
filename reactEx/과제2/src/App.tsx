    ...
    <>
      ...
      <div className="flex justify-center items-center min-h-screen">
        <div className="flex flex-col items-center gap-4  max-w-[500px]">
          ...
          <div>
            {city === "Seoul" && <img src={seoul} alt="Seoul" />}
            {city === "London" && <img src={london} alt="London" />}
            {city === "Paris" && <img src={paris} alt="Paris" />}
            {city === "NewYork" && <img src={newyork} alt="NewYork" />}
