...
watch(genre, (newValue) => {
  movieStore.getMovieDiscover(newValue, movieDetailList.value.title)
})
...
<template>
  <DetailTrailer :movie-trailer="movieTrailerList" :loading="movieTrailerListLoading" />
  <DetailInfo
